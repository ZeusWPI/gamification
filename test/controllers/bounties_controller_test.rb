...
class BountiesControllerTest < ActionController::TestCase
  ...
  test "should create bounty" do
    assert_difference('Bounty.count') do
      post :create, bounty: { coder_id: @bounty.coder_id, issue_id: @bounty.issue_id, value: @bounty.value }
    end
  ...
  test "should update bounty" do
    patch :update, id: @bounty, bounty: { coder_id: @bounty.coder_id, issue_id: @bounty.issue_id, value: @bounty.value }
    assert_redirected_to bounty_path(assigns(:bounty))
  end
